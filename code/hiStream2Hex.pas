...
function THIStream2Hex.Str2Hex;
var len: Integer;
begin
  FPos := 0;
  Check := 0;
...
function THIStream2Hex.Hex2Str;
...
function THIStream2Hex.Str2ASCII;
var i,len: Integer;
begin
  i := 0;
  FPos := 0;
...
procedure THIStream2Hex._work_doConvert0(var _Data:TData; Index:word);//StreamToHex
var S: String;
    St: PStream;
    len: integer;
begin
...
procedure THIStream2Hex._work_doConvert1(var _Data:TData; Index:word);//HexToStream
var S: String;
    St: PStream;
begin
...
procedure THIStream2Hex._work_doConvert2(var _Data:TData; Index:word);//StringToHex
begin
  _hi_CreateEvent(_Data,@_event_onResult,Str2Hex(ReadString(_Data,_data_Data)));
end;

procedure THIStream2Hex._work_doConvert3(var _Data:TData; Index:word);//HexToString
begin
  _hi_OnEvent(_event_onResult,Hex2Str(ReadString(_Data,_data_Data)));
end;

procedure THIStream2Hex._work_doConvert4(var _Data:TData; Index:word);//StreamToASCII
var S: String;
    St: PStream;
    len: integer;
begin
...
procedure THIStream2Hex._work_doConvert5(var _Data:TData; Index:word);//StrToASCII
begin
  _hi_CreateEvent(_Data,@_event_onResult,Str2ASCII(ReadString(_Data,_data_Data),(_prop_Symbol+#0)[1]));
end;

procedure THIStream2Hex._var_Position;
begin
   dtInteger(_data,FPos);
end;

procedure THIStream2Hex._var_CheckSum;
begin
